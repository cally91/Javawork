...
public class StdentVO {
	...
	private String 	st_dep_name;	//nvarchar2(5 char)
	...
	public String getSt_dep_name() {
		return st_dep_name;
	}
	public void setSt_dep_name(String st_dep_name) {
		this.st_dep_name = st_dep_name;
	}
	@Override
	public String toString() {
		return "StdentVO [st_no=" + st_no + ", st_name=" + st_name + ", st_addr=" + st_addr + ", st_grade=" + st_grade
				+ ", st_height=" + st_height + ", st_weight=" + st_weight + ", st_nick=" + st_nick + ", st_nick_rem="
				+ st_nick_rem + ", st_dep_name=" + st_dep_name + "]";
	}
