...
public class StuDestVO {
	...
	public StuDestVO(String st_no, String st_name, String st_addr, int st_grade, int st_height, int st_weight,
			String st_nick, String st_nick_rem, String st_dep_name) {
		super();
		this.st_no = st_no;
	...
	public void setSt_dept_name(String st_dep_name) {
		this.st_dept_name = st_dep_name;
	}
	@Override
	public String toString() {
		return "StuDestVO [st_no=" + st_no + ", st_name=" + st_name + ", st_addr=" + st_addr + ", st_grade=" + st_grade
				+ ", st_height=" + st_height + ", st_weight=" + st_weight + ", st_nick=" + st_nick + ", st_nick_rem="
				+ st_nick_rem + ", st_dep_name=" + st_dept_name + "]";
	}
